...
from yabc.transaction import Operation, make_transaction
...
class CsvAdhocTest(unittest.TestCase):
    ...
    def test_gifts(self):
        ...
        sale = make_transaction(Operation.SELL, 1, 0, 1001, date=self.start + self.one_day * 2)
    ...
    def test_mining(self):
        ...
        sold = make_transaction(Operation.SELL, 1, 0, 2000, date=self.start + self.one_day)

...
class TransactionTest(unittest.TestCase):
    def test_fees_no_proceeds(self):
        ...
        pool = [transaction.Transaction(
            'Buy', quantity=.5, source=None, proceeds=990., date=date, asset_name="BTC", fees=10)]
        sale = transaction.Transaction('Sell', quantity=.5, source=None, proceeds=1020., date=date, asset_name="BTC", fees=10)
